...
- **Commitlint**: Bắt buộc sử dụng chuẩn Conventional Commits. Lời nhắn commit theo cấu trúc sau: `type: subject` (Lưu ý: Bắt buộc phải có dấu cách sau dấu hai chấm).
