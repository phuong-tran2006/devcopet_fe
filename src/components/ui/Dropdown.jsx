...
const Dropdown = ({
  ...
  return (
    <div className={twMerge('relative flex flex-col', hasValidGap ? `gap-[${layout_gap}]` : 'gap-2')} ref={dropdownRef}>
      {label && (
        <label
          htmlFor={id || name}
      ...
      {isOpen && (
        ...
        >
          {options?.length === 0 ? (
            <li className="px-4 py-2 text-text-secondary">No options available</li>
          ) : (
