...
const toDisplayUser = (user: LeaderboardUser): DisplayUser => ({
  ...
  lifetimeXp: Number(user.lifetimeXp ?? user.currentXp ?? 0),
  lifetimeXpFormatted: Number(user.lifetimeXp ?? user.currentXp ?? 0).toLocaleString(),
                  ...
                  <div className="flex items-center gap-8 ml-auto pl-4">
                    <div className="hidden md:flex flex-col items-end">
                      ...
                      <span className="text-[13px] font-mono font-bold text-on-surface">
                        {currentUserRank.lifetimeXpFormatted}
                      </span>
                    </div>
                  </div>
                </div>
