import { HelpCircle, UserSearch } from "lucide-react";
        ...
        <>
          <div className="relative mb-4">
            <div className="w-[78px] h-[78px] rounded-full border-2 border-dashed dark:border-gray-600/30 border-outline/30 flex items-center justify-center transition-colors duration-300">
              <HelpCircle
                className="dark:text-gray-600/50 text-on-surface-variant/50"
                size={28}
              />
            </div>
          </div>
        ...
        <>
          <div className="relative mb-4">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <UserSearch
                className="dark:text-gray-500/80 text-on-surface-variant/80 transition-colors duration-300"
                size={28}
              />
            </div>
          </div>
