...
import { EmailIcon, LockIcon } from "src/components/ui/icons";
import { useAuthStore } from "src/features/users/store/auth.store";
import { authApi } from "src/features/users/api/auth.api";
import {
  googleIcon,
  githubIcon,
  facebookIcon,
  socialIconClassName,
} from "src/features/users/constants/authImages";
import mascotVideo from "src/assets/videos/7936438193787.mp4";
