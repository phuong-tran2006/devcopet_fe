...
const ModuleIcon = ({ index, isActive }) => {
  const icons = [
    ...
    <Braces size={24} strokeWidth={1.5} />,
...
const LessonCard = ({ lesson }) => {
  ...
  const iconMap = {
    mastered: <CheckCircle2 size={20} strokeWidth={1.5} />,
    in_progress: <PlayCircle size={20} strokeWidth={1.5} />,
    unlocked: <LockOpen size={20} strokeWidth={1.5} />,
    locked: <Lock size={20} strokeWidth={1.5} />,
  };
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        >
          <span className={`${iconColor[status]}`}>{iconMap[status]}</span>
        </div>
        <div>
          <h4
  ...
  if (!course) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        <AlertCircle size={48} className="text-on-surface-variant/40 mb-4" />
          ...
          <div className="w-full lg:w-[280px] flex-shrink-0">
            <div className="bg-surface-container border border-outline-variant rounded-xl p-6 shadow-[0_0_20px_rgba(0,0,0,0.15)]">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <BarChart3 size={20} className="text-on-surface-variant/40" />
              </div>
              ...
              <button
                ...
                disabled={resetting}
                className="w-full mt-5 h-11 rounded-lg border border-error/25 bg-error-container/45 px-4 text-xs font-bold text-error shadow-sm transition-all duration-200 flex items-center justify-center gap-2 hover:border-error/45 hover:bg-error-container/70 hover:shadow-[0_8px_20px_rgba(186,26,26,0.12)] focus:outline-none focus:ring-2 focus:ring-error/25 focus:ring-offset-2 focus:ring-offset-surface disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
        ...
        <div className="relative">
          ...
          {chapters.length === 0 && (
            <div className="bg-surface-container rounded-xl border border-outline-variant p-16 text-center shadow-[0_0_20px_rgba(0,0,0,0.15)]">
              <Inbox size={48} className="text-on-surface-variant/30 mb-4" />
