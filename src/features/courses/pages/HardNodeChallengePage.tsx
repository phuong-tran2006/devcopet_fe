...
const CodeSnippetCard = ({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-outline-variant/30 dark:border-[#263b44] bg-surface-container dark:bg-[#071217] shadow-sm dark:shadow-[0_0_22px_rgba(99,241,227,0.08)]">
      <div className="border-b border-outline-variant/30 dark:border-[#263b44] bg-surface-container-high dark:bg-[#0a161c] px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
        {codeSnippet.language}
      </div>
      <pre className="overflow-x-auto px-5 py-4 font-mono text-[15px] font-semibold leading-7 text-on-surface-variant dark:text-[#d7f7f4]">
...
const FeedbackPanel = ({
  ...
  return (
    <div
      className={`mx-6 mb-6 rounded-xl border px-5 py-5 shadow-sm dark:shadow-[0_0_24px_rgba(99,241,227,0.08)] ${
        isCorrect
          ? "border-primary/35 dark:border-[#63f1e3]/35 bg-primary/5 dark:bg-[#10262c]"
          : "border-error/30 dark:border-amber-300/30 bg-error/5 dark:bg-[#241b12]"
      }`}
    >
      <div className="flex items-start gap-3">
        <span
          className={`material-symbols-outlined mt-0.5 text-[22px] ${
            isCorrect
              ? "text-primary dark:text-[#63f1e3]"
              : "text-error dark:text-amber-200"
          }`}
        >
        ...
        <div className="min-w-0 flex-1">
          ...
          {explanation && (
            <div className="mt-4 rounded-lg border border-outline-variant/30 dark:border-white/10 bg-surface-container dark:bg-black/15 px-4 py-3">
          ...
          {hint && (
            <div className="mt-3 rounded-lg border border-primary/25 dark:border-[#63f1e3]/25 bg-primary/10 dark:bg-[#63f1e3]/10 px-4 py-3">
              <p className="text-[10px] font-bold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                Hint
              </p>
              <p className="mt-2 text-[14px] leading-relaxed text-on-surface-variant">
                {hint}
...
const HardNodeChallengePage = () => {
  ...
  const getOptionClass = (optionId: EasyChallengeOptionId) => {
    ...
    if (isCorrect) {
      return "border-primary dark:border-[#63f1e3] bg-primary/10 dark:bg-[#172d31] text-primary dark:text-[#63f1e3]";
    }
    if (isWrong) {
      return "border-error dark:border-[#ef4444] bg-error/10 dark:bg-[#2b171a] text-error dark:text-red-100";
    }
    if (isSelected) {
      return "border-primary dark:border-[#63f1e3] bg-primary/5 dark:bg-[#13282d] text-on-surface";
    }
    return "border-outline-variant/30 dark:border-[#1c2b33] bg-surface-container dark:bg-[#10191f] text-on-surface-variant hover:border-primary/50 dark:hover:border-[#63f1e3]/35 hover:text-on-surface";
  };
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-background dark:bg-[#071217] text-on-surface">
      <div className="flex min-h-[calc(100vh-80px)]">
        <aside className="hidden w-[246px] shrink-0 flex-col bg-surface-container dark:bg-[#0b171e] px-6 py-8 lg:flex">
        ...
        <section className="flex min-w-0 flex-1 flex-col px-5 py-9 md:px-8">
          {loading && (
            <div className="flex min-h-[520px] items-center justify-center">
              <div className="h-11 w-11 animate-spin rounded-full border-4 border-primary/45 dark:border-[#63f1e3]/45 border-t-transparent" />
            </div>
          )}

          {!loading && error && (
            <div className="mx-auto mt-16 max-w-[560px] rounded-2xl border border-error/20 dark:border-red-400/20 bg-error/10 dark:bg-red-400/10 px-6 py-8 text-center">
              <h1 className="text-[24px] font-extrabold text-error dark:text-on-surface">
          ...
          {!loading && !error && data && challenge && (
            <div className="mx-auto grid w-full max-w-[1080px] gap-6 xl:grid-cols-[minmax(0,1fr)_282px]">
              <section>
                  ...
                  {(isReviewMode || result) && (
                    <div className="text-right">
                      ...
                      <p className="mt-2 text-[28px] font-extrabold text-[#63f1e3]">
                        {(data.review?.correct ?? result?.correct)
                          ? "100%"
                          : "0%"}
                      </p>
                    </div>
                ...
                {isLockedMode && (
                  <div className="rounded-xl border border-outline-variant/30 dark:border-[#263b44] bg-surface dark:bg-[#111c23] p-8 text-center">
                ...
                {!isLockedMode && (
                  <div className="overflow-hidden rounded-xl border border-outline-variant/30 dark:border-[#263b44] bg-surface dark:bg-[#111c23] shadow-sm dark:shadow-[0_0_28px_rgba(99,241,227,0.08)]">
                    <div className="border-b border-outline-variant/30 dark:border-[#263b44] bg-surface-container dark:bg-[#0c171d] px-6 py-4">
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        <div className="min-w-0">
                          <p className="text-[11px] font-extrabold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                            Question 01
                          </p>
                    ...
                    <div className="border-b border-outline-variant/30 dark:border-[#263b44] px-6 py-7">
                    ...
                    {dragDropChallenge && (
                      <div className="grid gap-5 p-6 lg:grid-cols-[1fr_260px]">
                        <div className="rounded-xl border border-outline-variant/30 dark:border-[#263b44] bg-surface dark:bg-[#0b151b] p-5">
                          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                            <div>
                              <p className="text-[11px] font-bold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                                Template
                              </p>
                              <p className="mt-1 text-[12px] text-on-surface-variant">
                                Drag a pool item into a drop zone, or click an
                                item then click a drop zone.
                              </p>
                            </div>
                            {canEditDragDrop && (
                              <button
                                ...
                                className="rounded-lg border border-outline-variant/30 dark:border-[#263b44] px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-on-surface-variant transition hover:border-primary/45 dark:hover:border-[#63f1e3]/45 hover:text-primary dark:hover:text-[#63f1e3]"
                              >
                                Reset
                              </button>
                            )}
                          </div>
                          <div className="whitespace-pre-wrap rounded-xl border border-outline-variant/30 dark:border-[#1f333c] bg-surface-container dark:bg-[#071217] p-4 font-mono text-[15px] leading-10 text-on-surface">
                            {renderTemplateParts(
                                ...
                                return (
                                  <button
                                    ...
                                    className={`mx-1 inline-flex min-h-[46px] w-[156px] items-center justify-center rounded-lg border px-3 py-2 align-middle font-sans text-[13px] font-bold transition disabled:cursor-default ${
                                      correct
                                        ? "border-primary dark:border-[#63f1e3] bg-primary/15 dark:bg-[#63f1e3]/15 text-primary dark:text-[#63f1e3]"
                                        : wrong
                                          ? "border-error dark:border-[#ef4444] bg-error/12 dark:bg-[#ef4444]/12 text-error dark:text-red-100"
                                          : isDragTarget
                                            ? "border-primary dark:border-[#63f1e3] bg-primary/20 dark:bg-[#63f1e3]/20 text-primary dark:text-[#63f1e3] shadow-sm dark:shadow-[0_0_24px_rgba(99,241,227,0.28)]"
                                            : selectedItemId
                                              ? "border-blue-400 bg-blue-500/15 text-blue-700 dark:text-blue-100 shadow-sm dark:shadow-[0_0_16px_rgba(59,130,246,0.16)]"
                                              : isDraggingAnyItem
                                                ? "border-primary/75 dark:border-[#63f1e3]/75 bg-primary/10 dark:bg-[#63f1e3]/10 text-primary dark:text-[#63f1e3] shadow-sm dark:shadow-[0_0_18px_rgba(99,241,227,0.18)]"
                                                : canAssign
                                                  ? "border-gray-400 bg-gray-500/15 text-gray-700 dark:text-gray-200 shadow-sm dark:shadow-[0_0_14px_rgba(148,163,184,0.14)]"
                                                  : "border-dashed border-gray-400 dark:border-gray-500/70 bg-gray-500/10 text-gray-500 dark:text-gray-300"
                                    }`}
                                  >
                                    <span className="flex flex-col items-center leading-tight">
                                      ...
                                      {wrong && correctItemId && (
                                        <span className="mt-1 text-[10px] font-semibold text-primary dark:text-[#63f1e3]">
                                          Correct:{" "}
                        ...
                        <div className="rounded-xl border border-outline-variant/30 dark:border-[#263b44] bg-surface dark:bg-[#0b151b] p-5">
                          <p className="mb-4 text-[11px] font-bold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                            Pool Items
                          </p>
                                ...
                                <div
                                  ...
                                  className={`flex min-h-[56px] touch-none select-none items-center rounded-lg border px-4 py-3 text-left text-[14px] font-bold transition ${
                                    draggingPoolItemId === item.id
                                      ? "cursor-grabbing border-primary dark:border-[#63f1e3] bg-primary/12 dark:bg-[#63f1e3]/12 text-primary dark:text-[#63f1e3] opacity-45"
                                      : selectedPoolItemId === item.id
                                        ? "cursor-grab border-primary dark:border-[#63f1e3] bg-primary/12 dark:bg-[#63f1e3]/12 text-primary dark:text-[#63f1e3]"
                                        : used
                                          ? "cursor-grab border-outline-variant/30 dark:border-[#263b44] bg-surface-container dark:bg-[#10191f] text-on-surface-variant/55"
                                          : "cursor-grab border-outline-variant/30 dark:border-[#263b44] bg-surface-container dark:bg-[#10191f] text-on-surface-variant hover:text-on-surface"
                                  }`}
                                >
                                  {item.text}
                                </div>
                    ...
                    {submitError && (
                      <p className="mx-6 mb-6 rounded-lg border border-error/20 dark:border-red-400/20 bg-error/10 dark:bg-red-400/10 px-4 py-3 text-[13px] text-error dark:text-red-100/80">
                        {submitError}
                      </p>
                    )}
                    ...
                    {result &&
                      ...
                      !isLockedMode && (
                        <button
                          ...
                          className="mx-6 mb-6 w-[calc(100%-3rem)] rounded-xl border border-primary/45 dark:border-[#63f1e3]/45 bg-primary/10 dark:bg-[#63f1e3]/10 px-5 py-4 text-[13px] font-extrabold uppercase tracking-widest text-primary dark:text-[#63f1e3] transition hover:bg-primary/15 dark:hover:bg-[#63f1e3]/15"
                        >
                          Try Again
                        </button>
                      )}
                    ...
                    {!isReviewMode && !result && !isLockedMode && (
                      <button
                        ...
                        className="mx-6 mb-6 w-[calc(100%-3rem)] rounded-xl bg-primary dark:bg-[#63f1e3] px-5 py-4 text-[13px] font-extrabold uppercase tracking-widest text-on-primary dark:text-[#052023] transition hover:opacity-90 dark:hover:bg-[#86fff4] disabled:cursor-not-allowed disabled:bg-on-surface/10 disabled:text-on-surface-variant/45"
                      >
              ...
              <aside className="flex flex-col gap-5 xl:pt-[104px]">
                {(isReviewMode || result) && (
                  <div className="self-end rounded-lg border border-primary dark:border-[#63f1e3] px-4 py-3 text-[11px] font-extrabold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                    {(data.review?.correct ?? result?.correct)
                ...
                <div className="rounded-xl border border-primary dark:border-[#63f1e3]/70 bg-surface dark:bg-[#111c23] p-6 shadow-sm dark:shadow-[0_0_24px_rgba(99,241,227,0.08)]">
                  <div className="mb-5 flex items-center gap-4">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full border-4 border-primary dark:border-[#63f1e3] bg-primary/10 dark:bg-[#63f1e3]/10 text-primary dark:text-[#63f1e3]">
                  ...
                  {isReviewMode && data.review ? (
                    <>
                      <p className="text-[15px] font-bold italic leading-relaxed text-primary dark:text-[#63f1e3]">
                    ...
                    <p className="text-[14px] leading-relaxed text-on-surface-variant">
                      Select an answer, then submit to see your personalized
                      explanation.
                    </p>
                  )}
                  ...
                  <div className="mt-6">
                    ...
                    <div className="h-2 overflow-hidden rounded-full bg-outline-variant/30 dark:border-[#263944]">
                      <div
                        className="h-full rounded-full bg-primary dark:bg-[#63f1e3]"
                        style={{
                          width:
                            (data.review?.correct ?? result?.correct)
                              ? "85%"
                ...
                {isReviewMode && (
                  <button
                    ...
                    className="rounded-xl border border-outline/30 dark:border-[#263b44] bg-surface-container dark:bg-[#111c23] px-5 py-5 text-[14px] font-bold uppercase tracking-wide text-on-surface-variant transition hover:text-on-surface"
                  >
                    Back to Roadmap
                  </button>
                )}
                ...
                {result && (
                  <>
                    <button
                      ...
                      className="rounded-xl bg-primary dark:bg-[#63f1e3] px-5 py-5 text-[14px] font-extrabold uppercase tracking-wide text-on-primary dark:text-[#052023] transition hover:opacity-90 dark:hover:bg-[#86fff4]"
                    >
              ...
              {showSuccessModal && result?.correct && (
                <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/30 dark:bg-[#020815]/78 px-4 backdrop-blur-[6px]">
                  <div className="relative w-full max-w-[480px] rounded-3xl bg-surface-container dark:bg-[#2a3947] p-5 shadow-[0_0_60px_rgba(0,0,0,0.15)] dark:shadow-[0_0_60px_rgba(0,0,0,0.45)]">
                    <button
                      onClick={() => setShowSuccessModal(false)}
                      className="absolute right-5 top-5 z-10 flex h-8 w-8 items-center justify-center rounded-full text-on-surface-variant transition hover:bg-black/5 dark:hover:bg-white/8 hover:text-on-surface"
                    ...
                    <div className="rounded-xl bg-surface dark:bg-[#0f2630] px-8 pb-7 pt-8 shadow-sm dark:shadow-[inset_0_0_48px_rgba(99,241,227,0.06)]">
                      <div className="mx-auto mb-7 flex h-[88px] w-[88px] items-center justify-center rounded-full border border-primary dark:border-[#00c7bd] bg-primary/10 dark:bg-[#00c7bd]/10 text-primary dark:text-[#9afff7] shadow-sm dark:shadow-[0_0_30px_rgba(0,199,189,0.2)]">
                      ...
                      <div className="mt-6 rounded-lg border border-outline/20 dark:border-on-surface/10 bg-surface-container dark:bg-[#1b3440]/70 p-4">
                        <div className="flex items-start gap-3">
                          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-primary/25 dark:border-[#63f1e3]/25 bg-primary/12 dark:bg-[#63f1e3]/12 text-primary dark:text-[#63f1e3]">
                          ...
                          <div>
                            ...
                            <p className="mt-2 text-[12px] font-bold uppercase tracking-widest text-primary dark:text-[#63f1e3]">
                              Axo-Script
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="mt-7 grid grid-cols-2 gap-4">
                        <div className="rounded-lg bg-surface-container dark:bg-[#243932] px-4 py-4 text-center">
                          <p className="text-[11px] uppercase tracking-widest text-on-surface-variant">
                            Reward
                          </p>
                          <p className="mt-2 text-[24px] font-extrabold leading-none text-primary dark:text-[#63f1e3]">
                            +{challenge.xp}
                          </p>
                          <p className="text-[18px] font-bold text-primary dark:text-[#63f1e3]">
                            XP
                          </p>
                        </div>
                        <div className="rounded-lg bg-surface-container dark:bg-[#2e3330] px-4 py-4 text-center">
                          <p className="text-[11px] uppercase tracking-widest text-on-surface-variant">
                            Bonus
                          </p>
                          <p className="mt-2 text-[24px] font-extrabold leading-none text-purple-600 dark:text-[#f5c6ff]">
                            +10
                          </p>
                          <p className="text-[18px] font-bold text-purple-600 dark:text-[#f5c6ff]">
                            Stars
                          </p>
                        </div>
                      </div>
                      ...
                      <button
                        onClick={goToNextChallenge}
                        disabled={nextChallengeLoading}
                        className="mt-7 w-full rounded-lg bg-primary dark:bg-[#63f1e3] px-5 py-4 text-[12px] font-extrabold uppercase tracking-[0.18em] text-on-primary dark:text-[#052023] shadow-md dark:shadow-[0_10px_28px_rgba(99,241,227,0.24)] transition hover:opacity-90 dark:hover:bg-[#86fff4] disabled:cursor-wait disabled:opacity-70"
                      >
                        {nextChallengeLoading ? "Loading..." : "Next Challenge"}
