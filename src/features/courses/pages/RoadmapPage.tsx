    ...
    <main className="relative min-h-[calc(100vh-80px)] w-full flex flex-col items-center justify-start bg-background overflow-hidden pb-16 px-4 md:px-8 lg:px-16">
      ...
      <div className="relative z-10 w-full max-w-[1200px] flex flex-col items-stretch gap-8 mt-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-4">
          {/* Card 1: Python */}
          <div className="bg-white dark:bg-surface rounded-2xl border border-slate-200 dark:border-outline/30 p-6 flex flex-col hover:border-teal-500/50 dark:hover:border-primary-fixed-dim/50 shadow-sm hover:shadow-md dark:hover:shadow-[0_8px_30px_rgba(0,128,128,0.2)] transition-all duration-500 ease-out-cubic group relative overflow-hidden">
            {/* Logo Wrapper */}
            <div className="h-[100px] w-full bg-gradient-to-br from-cyan-50 via-teal-50 to-sky-100 dark:bg-none dark:bg-primary-fixed-dim/10 border border-slate-100 dark:border-primary-fixed-dim/10 rounded-xl flex items-center justify-center mb-6 relative overflow-hidden group-hover:from-cyan-100/50 group-hover:to-sky-200/50 dark:group-hover:bg-primary-fixed-dim/20 transition-all duration-300">
              <div className="rounded-2xl bg-white/90 dark:bg-transparent p-2.5 shadow-sm dark:shadow-none border border-slate-200/40 dark:border-none transition-all duration-300 group-hover:scale-105">
                <svg
                  viewBox="0 0 110 110"
            ...
            <div className="flex flex-col gap-2 mb-6">
              <h2 className="font-headline-sm text-[22px] font-bold text-slate-900 dark:text-on-surface tracking-wide group-hover:text-teal-600 dark:group-hover:text-primary transition-colors">
                Python World
              </h2>
              <p className="font-body-sm text-[12.5px] leading-relaxed text-slate-600 dark:text-on-surface-variant min-h-[54px] line-clamp-3">
            ...
            <div className="flex flex-col gap-1.5 mb-6">
              <div className="flex justify-between items-center text-[11px] font-black tracking-wider">
                ...
                <span className="text-teal-600 dark:text-primary">{pythonCompletion}%</span>
              </div>
              <div className="h-1.5 bg-slate-100 dark:bg-surface-container rounded-full overflow-hidden">
                <div
                  className="h-full bg-teal-600 dark:bg-primary-fixed-dim rounded-full shadow-[0_0_8px_rgba(13,148,136,0.3)] dark:shadow-[0_0_10px_rgba(0,128,128,0.4)]"
            ...
            <Link
              ...
              className="mt-auto w-full bg-teal-700 hover:bg-teal-800 dark:bg-primary-fixed-dim text-white dark:text-on-primary-fixed font-extrabold text-[12px] py-2.5 rounded-xl transition-all flex items-center justify-center gap-2 shadow-[0_4px_12px_rgba(13,148,136,0.15)] dark:shadow-[0_0_15px_rgba(0,128,128,0.3)] hover:scale-[1.02] active:scale-[0.98]"
            >
              Enter World{" "}
